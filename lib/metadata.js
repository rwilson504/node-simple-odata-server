...
function buildMetadata (model) {
  ...
  var complexTypeTag = complexTypes.length > 0 ? 'ComplexType' : '#comment';
  var complexTypeValue = complexTypes.length > 0 ? complexTypes : 'No Complex Types'
    ...
    'edmx:Edmx': {
      ...
      'edmx:DataServices': {
        'Schema': {
          ...
          complexTypeTag: complexTypeValue,
